...
#measured IV files
    ...
    def load_iv_file(self,filename):
        ...
        if error=='':
            ...
            (out.meas.date,out.meas.time,sample_name,out.cell.area,out.cell.area_units)=self.process_iv_setup(setup,*args)
...
#gwyddion ascii matrix you should write your matrix files like this so you can use sam load funciton 
